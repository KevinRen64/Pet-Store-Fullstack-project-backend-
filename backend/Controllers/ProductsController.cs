...
namespace backend.Controllers
{
    ...
    public class ProductsController : ControllerBase
    {
        ...
        //Create
        [HttpPost]
        public async Task<IActionResult> CreatePoduct([FromBody] CreateUpdatePoductDto dto)
        {
        ...
        [HttpPut]
        [Route("{id}")]
        public async Task<IActionResult> UpdateProduct([FromRoute] long id, [FromBody] CreateUpdatePoductDto dto)
        {
            var product = await _context.Products.FirstOrDefaultAsync(q => q.Id == id);
